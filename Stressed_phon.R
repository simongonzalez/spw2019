...
word_dataframe <- as.data.frame(df_test3)
word_dataframe <- word_dataframe[c("word","vowel","stressed_phonology","vowelDISC")]
write.csv(word_dataframe, 'word_dataframe.csv', row.names = F)
